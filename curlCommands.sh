...
#echo "" >> curl.log
#
echo "** Insert multiple Student objects"
...
## curl -X DELETE "http://localhost:80/gilhari/v1/Student" >> curl.log
## echo "" >> curl.log
#
#echo "** Query the count of all Student objects" >> curl.log
#curl -X GET   "http://localhost:80/gilhari/v1/Student/getAggregate?attribute=id&aggregateType=COUNT"  -H 'Content-Type: application/json' >> curl.log
#echo "" >> curl.log
#
